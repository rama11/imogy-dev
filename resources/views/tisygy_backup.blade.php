					...
					<div class="tab-content">
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-6 col-xs-12">
									<div class="info-box">
										...
										<div class="info-box-content">
											<span class="info-box-text">On Progress Ticket</span>
								...
								<div class="col-md-3 col-sm-6 col-xs-12">
									<div class="info-box">
										...
										<div class="info-box-content">
											<span class="info-box-text">Pandding Ticket</span>
						...
						<div class="tab-pane table-responsive no-padding" id="tab_3">
							...
							<table class="table table-bordered table-striped" id="tablePerformace">
								<tr>
									<th style="width: 150px;vertical-align: middle;">ID Ticket</th>
									<th style="width: 50px">ID ATM*</th>
									<th style="width: 100px">Serial Number</th>
									<!-- <th style="width: 100px">Number Tiket</th> -->
									<th style="width: 100px;vertical-align: middle;">Open</th>
									<th style="vertical-align: middle;">Problem</th>
									<th style="width: 40px;vertical-align: middle;">PIC</th>
									<th style="width: 40px;vertical-align: middle;">Location</th>
									<th style="width: 40px;vertical-align: middle;">Status</th>
									<th colspan="2" style="width: 40px;vertical-align: middle;">Operator</th>
								</tr>
								<tr>
									<td style="width: 150px;vertical-align: middle;">30/TTNI/Mar/2018</td>
									<td style="width: 50px; vertical-align: middle;"> - </td>
									<td style="width: 100px; vertical-align: middle;">TATA791261</td>
									<!-- <td style="width: 100px; vertical-align: middle;">51705282	</td> -->
									<td style="width: 40px" class="text-center">6 March 2018 08:45</td>
									<td>Printer Rusak</td>
									<td style="width: 100px">Rangga - 082302474400</td>
									<td style="width: 40px">PDC Tabanan</td>
									<td style="width: 40px; vertical-align: middle;text-align: center"><span class="label label-danger">Open</span></td>
									<td style="width: 40px; vertical-align: middle;">Feby</td>
									<td style="width: 40px; vertical-align: middle;text-align: center"><button class="btn btn-default" onclick="showTicket(808)">Detail</button></td>
								</tr>
								<tr>
									<td style="width: 150px;vertical-align: middle;">30/TTNI/Mar/2018</td>
									<td style="width: 50px; vertical-align: middle;"> - </td>
									...
									<td style="width: 100px">Rangga - 082302474400</td>
									<td style="width: 40px">PDC Tabanan</td>
									<td style="width: 40px; vertical-align: middle;text-align: center"><span class="label label-success">Close</span></td>
									<td style="width: 40px; vertical-align: middle;">Feby</td>
									<td style="width: 40px; vertical-align: middle;text-align: center"><button class="btn btn-default">Detail</button></td>
								</tr>
							</table>
...
<script>
	...
	function getDashboard(){
		$.ajax({
			...
			success:function(result){
				console.log(result)
				$("#countOpen").text(result[0]);
				$("#countProgress").text(result[1]);
				$("#countPending").text(result[2]);
				$("#countClose").text(result[3]);
			}
		});
	}
	...
	function getPerformance(){
		...
		heading = heading + '<thead>';
			heading = heading + '<tr>';
				...
				heading = heading + '<th style="text-align:center;width: 100px">Serial Number</th>';
				...
				heading = heading + '<th colspan="2" style="width: 40px;vertical-align: middle;">Operator</th>';
			heading = heading + '</tr>';
		heading = heading + '</thead>';
			...
			success:function(result){
				...
				$.each(result, function(key,value){
					body = body + '<tr>';
						...
						body = body + '<td style="width: 100px; vertical-align: middle;">' + value.serial_device + '</td>';

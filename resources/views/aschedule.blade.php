							...
							@foreach($users as $user)
								<li class="{{$user->on_project}}" style="display: none;">
									<a href="#" onclick="showDetail('{{$user->name}}','{{$user->id}}','{{$user->on_project}}')">{{$user->name}}
										<small class="label label-success pull-right" style="margin-right: 5px;">{{$user->shift_libur}}</small>
										<small class="label label-primary pull-right" style="margin-right: 5px;">{{$user->shift_malam}}</small>
										<small class="label label-warning pull-right" style="margin-right: 5px;">{{$user->shift_sore}}</small>
										<small class="label label-danger pull-right"  style="margin-right: 5px;">{{$user->shift_pagi}}</small>
									</a>
								</li>
							@endforeach
						</ul>

					...
					<div class="box-body">
						...
						<!-- <table class="table table-bordered" id="detail_table">
							...
							<tbody>
								<tr>
									<td>AGUSTUS</td>
									<td><button type="button" class="btn btn-info"><i class="fa fa-download"></i> Download</button></td>									
								</tr>
							</tbody>
						</table> -->
					</div>
	...
	$(function () {
		...
		$('#daterange-btn').daterangepicker(
			...
			function (start, end) {
				...
				// Di buat untuk donwload
				startDonwload = startDay;
				endDonwload = endDay;

				// Dintampilkan di bawahnya

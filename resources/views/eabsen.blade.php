...
<div class="content-wrapper">
	...
	<section class="content-header" >
		<img src="img/labelaogy.png" width="120" height="40">S
		<ol class="breadcrumb" style="font-size: 15px;">
			<li><a href="{{url('ehistory')}}"><i class="fa fa-book"></i>My Absent History</a></li>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNVCp8lA_LCRxr1rCYhvFIUNSmDsbcGno"></script>
@endsection
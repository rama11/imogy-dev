				...
				<div class="box" id="panel_simple">
					...
					<div class="box-body col-md-8">
						...
						<!-- <ul class="pagination pull-left">
						  ...
						  <br>
						  <p class="text-left">
							For more other history information. Click <a href="{{url('/precense/myhistory/detail')}}" style="cursor:pointer">here</b>
						  </p>
						  <a href="{{url('/precense/teamhistory/getIndifidualHistory',Auth::user()->id)}}">
